...
class PointCloudPreprocess {
   public:
    ...
    /// processors
    void PCProcess(const livox_ros_driver::CustomMsg::ConstPtr &msg, PointCloudType::Ptr &pcl_out);
    void PCProcess(const sensor_msgs::PointCloud2::ConstPtr &msg, PointCloudType::Ptr &pcl_out);
